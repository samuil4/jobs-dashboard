export default {
  ...
  clients: {
    ...
    listFilterLabel: 'Job list filter',
    listFilterAll: 'All jobs',
    listFilterActiveOnly: 'Active only',
    listFilterNoInvoice: 'Without invoice',
    listFilterWithInvoice: 'With invoice',
  ...
  jobs: {
    ...
    invoice: 'Invoice',
    /** Short label shown next to status (e.g. "inv: 12345") */
    invoiceAbbr: 'inv',
    ...
    collapseArchivedPanel: 'Collapse archived jobs panel',
    expandArchivedPanel: 'Expand archived jobs panel',
    mainListEmpty: 'No jobs match your filters.',
    archivedDrawerEmpty: 'No archived jobs.',
    filter: {
      showArchived: 'Show archived',
      hideArchived: 'Hide archived',
      status: 'Status filter',
      invoiceAll: 'All invoices',
